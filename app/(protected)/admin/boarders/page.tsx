...
export default function AdminBoardersPage() {
    ...
    <div className="flex min-h-[calc(100vh-80px)]">
      ...
      <section className="flex-1 px-8 py-12">
        <div className="flex items-center justify-between mb-8">
          <h1 className="text-2xl font-medium tracking-wide">Boarders</h1>
          <Link
            href="/admin"
        ...
        <div className="border border-gray-200 p-12 text-center">
          <p className="text-gray-400 text-sm tracking-wider">Boarders content coming soon</p>
        </div>
      </section>
    </div>
  )
