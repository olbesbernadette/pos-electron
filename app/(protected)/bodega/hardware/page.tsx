...
export default function BodegaHardwarePage() {
    ...
    <>
      <div className="flex items-center justify-between mb-8">
        <div className="flex items-center gap-3">
          ...
          <h1 className="text-2xl font-medium tracking-wide">Hardware</h1>
        </div>
        <Link
          href="/bodega"
      ...
      <div className="border border-gray-200">
        ...
        {/* Content Area */}
        <div>
          {selectedAction === "out" && <BodegaForm warehouseId={3} />}

          {selectedAction === "in" && <BodegaInForm warehouseId={3} />}

          {selectedAction === "logs" && <BodegaLogs warehouseId={3} />}
        </div>
      </div>
    </>
  )
